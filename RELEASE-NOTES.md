...
v0.9.26 advances the v0.9.25 read-only live roster comparison into a deliberately narrow teacher-approved sync path with the Hall Pass / Check-In Version 29 bridge.
...
GoClassroom v0.9.26 does not automatically remove students. Even when a Classroom roster is complete enough to identify a likely removal, the item is labeled **REVIEW REMOVE** and is not included in the server request.
