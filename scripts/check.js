...
const files=['main.js','preload.js','renderer/app.js','main-services/local-data.js','main-services/engine-runner.js','main-services/ai-service.js','main-services/grading-service.js','main-services/ready-service.js','main-services/scheduler-service.js','engine/app-config.js','engine/json-store.js','engine/protocol.js','engine/classroom-actions.js','engine/classroom-discovery.js','engine/lib.js','engine/safety.js','engine/browser.js','engine/classroom-picker.js','engine/drive-picker.js','engine/preflight.js','engine/submit-weekly.js','engine/select-course.js','engine/select-grading-course.js','engine/discover-topics.js','engine/select-drive-folder.js','engine/scan-drive-folder.js','engine/scheduler.js','engine/dom-helpers.js','engine/validation.js','engine/ai-recovery.js','engine/grading.js','engine/ready-snapshot.js','engine/ready-scan.js','engine/docx-writer.js','engine/upload-draft-plan.js','engine/retry-policy.js','engine/browser-mode.js','engine/page-evidence.js'];
...
if(!htmlSource.includes('v0.9.22'))throw new Error('Teacher Edition sidebar version is stale');
...
if(pkg.version!=='0.9.22')throw new Error('package.json version is not 0.9.22');
...
if(!htmlSource.includes('v0.9.22'))throw new Error('Teacher Edition sidebar version is not v0.9.22');
...
console.log('Project syntax, Trust/Reliability safety, Teacher Edition, multi-Classroom grading, optional private review export, and v0.9.22 GoClassroom preview checks passed.');
