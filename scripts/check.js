...
if(!htmlSource.includes('v0.9.32'))throw new Error('Teacher Edition sidebar version is stale');
...
if(pkg.version!=='0.9.32')throw new Error('package.json version is not 0.9.32');
...
if(!htmlSource.includes('v0.9.32'))throw new Error('Teacher Edition sidebar version is not v0.9.32');
...
console.log('Project syntax, Trust/Reliability safety, Teacher Edition, multi-Classroom grading, approved roster sync, optional private review export, and v0.9.32 GoClassroom preview checks passed.');
