...
const cases=[
  ...
  ['Choose one of your saved grading Classrooms before continuing.','grading:process-classroom','AT-GRD-208'],
  ['Grading Classroom selection was canceled.','grading:select-classroom','AT-GRD-194'],
  ['That grading Classroom is not in the saved list.','grading:remove-classroom','AT-GRD-193'],
  ['Review folder selection failed.','grading:select-review-folder','AT-GRD-192'],
  ['The grading review folder moved.','grading:open-review-folder','AT-GRD-191'],
  ['Ready report is unavailable.','ready:get-latest','AT-RDY-199'],
  ['Ready classroom preflight stopped.','ready:scan','AT-RDY-198'],
  ['Ready report could not be saved.','ready:export','AT-RDY-197'],
