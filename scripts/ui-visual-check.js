...
(async()=>{
  ...
  const output=path.resolve(process.argv[2]||path.join(__dirname,'..','validation-evidence-v0.9.22'));
  ...
  try{
    ...
    await page.screenshot({path:path.join(output,'goclassroom-v0.9.22-home.png'),fullPage:true});
    ...
    await page.screenshot({path:path.join(output,'goclassroom-v0.9.22-draft-grading.png'),fullPage:true});
