...
(async()=>{
  ...
  const output=path.resolve(process.argv[2]||path.join(__dirname,'..','validation-evidence-v0.9.29'));
  ...
  try{
    ...
    await page.screenshot({path:path.join(output,'goclassroom-v0.9.29-home.png'),fullPage:true});
    ...
    await page.screenshot({path:path.join(output,'goclassroom-v0.9.29-draft-grading.png'),fullPage:true});
