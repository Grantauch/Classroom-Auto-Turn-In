...
(async()=>{
  ...
  const output=path.resolve(process.argv[2]||path.join(__dirname,'..','validation-evidence-v0.9.21'));
  ...
  try{
    ...
    await page.screenshot({path:path.join(output,'goclassroom-v0.9.21-home.png'),fullPage:true});
    ...
    await page.screenshot({path:path.join(output,'goclassroom-v0.9.21-draft-grading.png'),fullPage:true});
