...
assert(html.includes('v0.9.20')&&ui.includes('v0.9.20'),'v0.9.20 UI version labels are missing');
console.log('v0.9.20 silent-operation and conditional-retry checks passed.');
