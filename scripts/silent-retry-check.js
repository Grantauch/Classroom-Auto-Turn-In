...
assert(html.includes('v0.9.26')&&ui.includes('v0.9.26'),'v0.9.26 UI version labels are missing');
console.log('v0.9.26 silent-operation and conditional-retry checks passed.');
