...
assert(html.includes('v0.9.32')&&ui.includes('v0.9.32'),'v0.9.32 UI version labels are missing');
console.log('v0.9.32 silent-operation and conditional-retry checks passed.');
