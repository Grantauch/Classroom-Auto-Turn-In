...
assert(html.includes('v0.9.27')&&ui.includes('v0.9.27'),'v0.9.27 UI version labels are missing');
console.log('v0.9.27 silent-operation and conditional-retry checks passed.');
