...
assert(html.includes('v0.9.28')&&ui.includes('v0.9.28'),'v0.9.28 UI version labels are missing');
console.log('v0.9.28 silent-operation and conditional-retry checks passed.');
