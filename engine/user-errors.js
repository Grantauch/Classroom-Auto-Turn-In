...
const FALLBACK={
  ...
  'ready:get-latest':['AT-RDY-199','Ready could not load the last classroom preflight. Run the Ready check again.'],
  'ready:scan':['AT-RDY-198','Ready could not finish the classroom preflight safely. Nothing was changed in Classroom. Try the check again.'],
  'ready:export':['AT-RDY-197','The Ready report could not be saved. Run Ready again or choose another folder.'],
