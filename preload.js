...
const fallbackByChannel={
  ...
  'ready:get-latest':['AT-RDY-199','Ready could not load the last classroom preflight. Run the check again.'],
  'ready:scan':['AT-RDY-198','Ready could not finish the classroom preflight safely. Nothing was changed in Classroom.'],
...
contextBridge.exposeInMainWorld('cati',{
  ...
  getReadyState:()=>invoke('ready:get-latest'),
  runReadyScan:()=>invoke('ready:scan'),
  exportReadySnapshot:()=>invoke('ready:export'),
