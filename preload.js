...
const fallbackByChannel={
  ...
  'roster:save-bridge':['AT-ROS-107','The Hall Pass link could not be saved. No Hall Pass or Check-In roster was changed.'],
...
contextBridge.exposeInMainWorld('cati',{
  ...
  getRosterState:()=>invoke('roster:get-state'),
  discoverClassroomRosters:()=>invoke('roster:discover'),
  readOperationsRoster:()=>invoke('roster:read-operations'),
  applySafeRosterChanges:()=>invoke('roster:apply-safe'),
  saveRosterMappings:(v)=>invoke('roster:save-mappings',v),
  saveRosterBridge:(v)=>invoke('roster:save-bridge',v),
